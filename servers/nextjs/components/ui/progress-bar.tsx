    ...
    return (
        <div className="w-full space-y-2">
            ...
            <div className="w-full bg-white/40 rounded-full h-2 overflow-hidden">
                <div
                    className="h-full bg-gradient-to-r from-[var(--gslide-accent)] via-[var(--gslide-accent-hover)] to-[var(--gslide-accent)] rounded-full animate-gradient transition-all duration-300 ease-out"
                    style={{
                        width: `${progress}%`,
